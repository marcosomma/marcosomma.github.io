...
const getTexts = (fileName) => {
    let text = {
        ...
        headerAignment : {v:GUI.Control.VERTICAL_ALIGNMENT_TOP,h:GUI.Control.HORIZONTAL_ALIGNMENT_LEFT},
        mainTextMargins : {t:30,l:5},
        mainTextAignment : {v:GUI.Control.VERTICAL_ALIGNMENT_TOP,h:GUI.Control.HORIZONTAL_ALIGNMENT_LEFT},
        citMargins : {b:15,l:5},
        citAignment : {v:GUI.Control.VERTICAL_ALIGNMENT_BOTTOM,h:GUI.Control.HORIZONTAL_ALIGNMENT_LEFT},
        citAuthMargins : {b:0,r:5},
        citAuthAignment : {v:GUI.Control.VERTICAL_ALIGNMENT_BOTTOM,h:GUI.Control.HORIZONTAL_ALIGNMENT_RIGHT},
    }
    switch (fileName) {
        case 'CX':
            text.header = 'Center'
        ...
        case 'LX':
            ...
            text.mainText = "Responsible for control of the left side of the body, and is the more artistic and creative side of the brain. \nIt's also controlling, Art awareness, Creativity, Imgination, Insight, Holistic thought, Music awareness, 3-D forms and much more..."
            text.cit = 'Logic will get you from A to B. Imagination will take you everywhere.'
...
export const getGUIBrainPart = (fileName ,importedBrainPart, advancedTexture) => 
    {
        ...
        const header = getTextBox(texts.header, 'black', 500, 14, texts.headerMargins, texts.headerAignment)
        const mainText = getTextBox(texts.mainText, 'black', 100, 12, texts.mainTextMargins, texts.mainTextAignment)
        const cit = getTextBox(texts.cit, 'black', 100, 10, texts.citMargins, texts.citAignment)
        const citAuth = getTextBox(texts.citAuth, 'black', 500, 9, texts.citAuthMargins, texts.citAuthAignment)
